...
with DAG(
    ...
    bigquery_external_table_task = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            "tableReference": {
                ...
                "tableId": f"{colour}_{DATASET}_external_table_latest",
            },
            "externalDataConfiguration": {
                ...
                "sourceUris": [f"gs://{BUCKET}/{colour}_latest/*"],
            },
        },
    )
    ...
    CREATE_BQ_TBL_QUERY = f"CREATE OR REPLACE TABLE {BIGQUERY_DATASET}.{colour}_{DATASET} \
        ...
        AS \
        SELECT * FROM {BIGQUERY_DATASET}.{colour}_{DATASET}_external_table_latest;"
